...
class NavigationHelper
{
    ...
    public static function getIcon($iconName, $size = 'w-5 h-5 mr-3')
    {
        $icons = [
            ...
            'stock-name-management' => '<svg class="'.$size.'" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M7 7h4l8 8a2 2 0 010 2.83l-3.17 3.17a2 2 0 01-2.83 0L5 12V7a2 2 0 012-2z" />
                                        </svg>',
            ...
            'markup_price' => '<svg class="'.$size.'" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <!-- Price Tag -->
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M7 7l-4 4 7 7 4-4V7H7z" />

                                <!-- Upward Arrow (markup indicator) -->
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M14 3l3 3-3 3M17 6H9" />
                            </svg>',
    ...
    public static function getBreadcrumbs()
    {
        ...
        $breadcrumbMap = [
            ...
            'purchases.purchase-orders.show' => [
                ['label' => 'Purchases', 'url' => null],
                ['label' => 'Purchase Orders', 'url' => route('purchases.purchase-orders.index')],
            ...
            'purchases.purchase-orders.edit' => [
                ['label' => 'Purchases', 'url' => null],
                ['label' => 'Purchase Orders', 'url' => route('purchases.purchase-orders.index')],
                ['label' => 'Edit Purchase Order', 'url' => null],
            ],
            ...
            'purchases.purchase-receives.show' => [
                ['label' => 'Purchases', 'url' => null],
                ['label' => 'Goods Received', 'url' => route('purchases.purchase-receives.index')],
                ['label' => 'View Details', 'url' => null],
            ],
            ...
            'reports.product-movement' => [
                ['label' => 'Reports', 'url' => route('reports.index')],
                ['label' => 'Product Movement Report', 'url' => null],
            ],

            'reports.reorder' => [
                ['label' => 'Reports', 'url' => route('reports.index')],
                ['label' => 'Reorder Items', 'url' => null],
            ],
            ...
            'sales.returns.index' => [
                ['label' => 'Sales', 'url' => null],
                ['label' => 'Returns', 'url' => route('sales.returns.index')],
            ],

            'sales.returns.create' => [
                ['label' => 'Sales', 'url' => null],
                ['label' => 'Returns', 'url' => route('sales.returns.index')],
                ['label' => 'Record Return', 'url' => route('sales.returns.create')],
            ],
