                        ...
                        <div class="bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
                            ...
                            <div class="bg-blue-50 dark:bg-blue-900 p-4 rounded-lg mb-4">
                                <p class="text-sm text-blue-700 dark:text-blue-300">
                                    ...
                                    <strong>Note:</strong> Sales orders are received from the e-commerce application. Order prefixes are managed by the e-commerce system.
                                </p>
                            </div>
                            
                            <div class="grid grid-cols-1 gap-6">
                                <!-- Order Prefix - Read Only Info -->
                                <div>
                                    <x-input-label for="order_prefix" :value="__('Sales Order Prefix (Info Only)')" />
                                    <x-text-input id="order_prefix" name="order_prefix" type="text" class="mt-1 block w-full bg-gray-100 dark:bg-gray-700" :value="old('order_prefix', $settings['order_prefix'] ?? 'SO-')" readonly />
                                    <p class="mt-1 text-sm text-gray-500">Order numbers are generated by the e-commerce application</p>
                                </div>
                            </div>
                        </div>
