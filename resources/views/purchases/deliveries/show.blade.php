            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                        <div>
                            <h2 class="text-2xl font-bold text-gray-900 dark:text-white">Delivery:
                    ...
                    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Delivery
                                        Number</label>
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Delivery
                                        Date</label>
                                    <p class="mt-1 text-sm text-gray-900 dark:text-white">
                                        {{ $delivery->delivery_date->format('M d, Y') }}</p>
                                </div>
                                ...
                                <div>
                                    ...
                                    <span
                                        class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ $delivery->status_badge_class }}">
                                ...
                                <div>
                                    ...
                                    <span
                                        class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ $delivery->priority_badge_class }}">
                                ...
                                <div>
                                    ...
                                    <p class="mt-1 text-sm text-gray-900 dark:text-white">
                                        {{ $delivery->carrier ?? 'N/A' }}</p>
                                </div>

                                <div>
                                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Tracking
                                        Number</label>
                                    <p class="mt-1 text-sm text-gray-900 dark:text-white">
                                        {{ $delivery->tracking_number ?? 'N/A' }}</p>
                                </div>

                                <div>
                                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Scheduled
                                        Delivery</label>
                                    <p class="mt-1 text-sm text-gray-900 dark:text-white">
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Actual
                                        Delivery</label>
                                    <p class="mt-1 text-sm text-gray-900 dark:text-white">
                        ...
                        <div class="p-6">
                            ...
                            <div class="space-y-3">
                                <div class="flex justify-between">
                                    ...
                                    <span
                                        class="text-sm font-medium text-gray-900 dark:text-white">{{ number_format($delivery->total_quantity_delivered) }}</span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-sm text-gray-600 dark:text-gray-400">Total Packages:</span>
                                    <span
                                        class="text-sm font-medium text-gray-900 dark:text-white">{{ $delivery->total_packages }}</span>
                                </div>
                                @if ($delivery->total_weight)
                                    <div class="flex justify-between">
                                        <span class="text-sm text-gray-600 dark:text-gray-400">Total Weight:</span>
                                        <span
                                            class="text-sm font-medium text-gray-900 dark:text-white">{{ number_format($delivery->total_weight, 2) }}
                                            kg</span>
                                    </div>
                                @endif
                                <div class="flex justify-between">
                                    ...
                                    <span
                                        class="text-sm font-medium text-gray-900 dark:text-white">₱{{ number_format($delivery->shipping_cost, 2) }}</span>
                                </div>
                                @if ($delivery->insurance_cost > 0)
                                    <div class="flex justify-between">
                                        <span class="text-sm text-gray-600 dark:text-gray-400">Insurance:</span>
                                        <span
                                            class="text-sm font-medium text-gray-900 dark:text-white">₱{{ number_format($delivery->insurance_cost, 2) }}</span>
                                    </div>
                                @endif
                                <div class="border-t border-gray-200 dark:border-gray-700 pt-3">
                                    <div class="flex justify-between">
                                        <span class="text-sm font-medium text-gray-900 dark:text-white">Total
                                            Amount:</span>
                                        <span
                                            class="text-sm font-bold text-gray-900 dark:text-white">₱{{ number_format($delivery->total_amount_delivered, 2) }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    @if ($delivery->status !== 'delivered' && $delivery->status !== 'cancelled')
                        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                            <div class="p-6">
                                ...
                                <form
                                    action="{{ route('purchases.deliveries.change-status', $delivery->delivery_id) }}"
                                    method="POST">
                                    @csrf
                                    <div class="space-y-4">
                                        <div>
