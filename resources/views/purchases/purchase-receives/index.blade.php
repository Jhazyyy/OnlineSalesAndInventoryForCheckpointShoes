                                            ...
                                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                                ...
                                                <td class="px-3 sm:px-4 lg:px-6 py-4 whitespace-nowrap">
                                                    <div class="text-sm font-medium text-gray-900 dark:text-white">
                                                        <a href="{{ route('purchases.purchase-receives.show', $receive->receive_id) }}" class="text-blue-600 hover:text-blue-900 dark:hover:text-blue-400">
                                                ...
                                                <td class="px-3 sm:px-4 lg:px-6 py-4 whitespace-nowrap">
                                                    <div class="text-sm text-gray-900 dark:text-white">
                                                        @if($receive->purchaseOrder)
                                                            <a href="{{ route('purchases.purchase-orders.show', $receive->purchase_order_id) }}" class="text-blue-600 hover:text-blue-900 dark:hover:text-blue-400">
                                                ...
                                                <td class="px-3 sm:px-4 lg:px-6 py-4 whitespace-nowrap">
                                                    <div class="w-20 sm:w-24 lg:w-full bg-gray-200 rounded-full h-2 dark:bg-gray-700">
                                                ...
                                                <td class="px-3 sm:px-4 lg:px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                    <div class="flex justify-center space-x-2">
                                                        <a href="{{ route('purchases.purchase-receives.show', $receive->receive_id) }}" 
                                                           class="text-indigo-600 hover:text-indigo-900 dark:hover:text-indigo-400" title="View">
                                                        ...
                                                        @if($receive->canBeEdited())
                                                            <a href="{{ route('purchases.purchase-receives.edit', $receive->receive_id) }}" 
                                                               class="text-blue-600 hover:text-blue-900 dark:hover:text-blue-400" title="Edit">
                                                                <svg class="w-4 h-4 sm:w-5 sm:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
