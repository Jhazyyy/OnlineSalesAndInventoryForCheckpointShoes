    ...
    <div class="py-6">
        <div class="w-full mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                        <div>
                            <h2 class="text-2xl font-bold text-gray-900 dark:text-white">Create New Purchase Return</h2>
                            <p class="text-gray-600 dark:text-gray-400">Return items to supplier</p>
                        </div>
                        <div>
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <form method="POST" action="{{ route('purchases.purchase-returns.store') }}" class="space-y-6">
                        @csrf
                                ...
                                <select id="purchase_order_id" name="purchase_order_id"
                                    ...
                                    @foreach($purchaseOrders as $order)
                                        <option value="{{ $order->id }}" 
                                                {{ old('purchase_order_id') == $order->id ? 'selected' : '' }}>
