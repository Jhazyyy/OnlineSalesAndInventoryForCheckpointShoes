<x-app-layout>
    <div class="py-6">
        <div class="w-full mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                        <div>
                            <h2 class="text-2xl font-bold text-gray-900 dark:text-white">Purchase Returns Management</h2>
                            <p class="text-gray-600 dark:text-gray-400">Manage returns to suppliers</p>
                        </div>
                        <div class="flex flex-col sm:flex-row gap-3 mt-4 sm:mt-0">
                            <a href="{{ route('purchases.purchase-returns.analytics') }}" 
                            ...
                            <a href="{{ route('purchases.purchase-returns.create') }}" 
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6">
                    <form method="GET" action="{{ route('purchases.purchase-returns.index') }}" class="space-y-4">
                ...
                <div class="p-6">
                    @if($returns->count() > 0)
                        ...
                        <div class="mb-4 flex flex-wrap gap-2">
                            <form method="POST" action="{{ route('purchases.purchase-returns.bulk-approve') }}" style="display: inline;" onsubmit="return confirm('Are you sure you want to approve selected returns?')">
                                @csrf
                            ...
                            <form method="POST" action="{{ route('purchases.purchase-returns.bulk-reject') }}" style="display: inline;" onsubmit="return confirm('Are you sure you want to reject selected returns?')">
                                @csrf
                                    ...
                                    @foreach($returns as $return)
                                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900 dark:text-white">
                                                #PR-{{ str_pad($return->return_id, 6, '0', STR_PAD_LEFT) }}
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                <div class="flex items-center space-x-2">
                                                    <a href="{{ route('purchases.purchase-returns.show', $return) }}" 
                                                       class="text-indigo-600 hover:text-indigo-900 dark:text-indigo-400 dark:hover:text-indigo-300">
                                                        View
                                                    </a>
                                                    
                                                    @if($return->isPending())
                                                        <a href="{{ route('purchases.purchase-returns.edit', $return) }}" 
                                                           class="text-blue-600 hover:text-blue-900 dark:text-blue-400 dark:hover:text-blue-300">
                                                            Edit
                                                        </a>
                                                        
                                                        <form method="POST" action="{{ route('purchases.purchase-returns.approve', $return) }}" style="display: inline;">
                                                            @csrf
                                                            <button type="submit" 
                                                                    class="text-green-600 hover:text-green-900 dark:text-green-400 dark:hover:text-green-300"
                                                                    onclick="return confirm('Are you sure you want to approve this purchase return?')">
                                                                Approve
                                                            </button>
                                                        </form>
                                                        
                                                        <form method="POST" action="{{ route('purchases.purchase-returns.reject', $return) }}" style="display: inline;">
                                                            @csrf
                                                            <button type="submit" 
                                                    ...
                                                    @elseif($return->isApproved())
                                                        <form method="POST" action="{{ route('purchases.purchase-returns.mark-as-processed', $return) }}" style="display: inline;">
                                                            @csrf
                                                            <button type="submit" 
                                                                    class="text-blue-600 hover:text-blue-900 dark:text-blue-400 dark:hover:text-blue-300"
                                                    ...
                                                    @elseif($return->isProcessed())
                                                        <form method="POST" action="{{ route('purchases.purchase-returns.mark-as-refunded', $return) }}" style="display: inline;">
                                                            @csrf
                                                            <button type="submit" 
                    ...
                    @else
                        <div class="text-center py-12">
                            ...
                            <h3 class="mt-2 text-sm font-medium text-gray-900 dark:text-white">No purchase returns found</h3>
                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Get started by creating a new purchase return.</p>
                            <div class="mt-6">
                                <a href="{{ route('purchases.purchase-returns.create') }}" 
                                   class="inline-flex items-center px-4 py-2 bg-blue-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-blue-700 focus:bg-blue-700 active:bg-blue-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150">
                                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
