                                ...
                                <select id="payment_mode" name="payment_mode" 
                                    ...
                                    @foreach($paymentModes as $mode)
                                        <option value="{{ $mode }}" {{ request('payment_mode') == $mode ? 'selected' : '' }}>
                                            @if($mode == 'icici_bank')
                                                ICICI Bank
                                            @elseif($mode == 'standard_chartered')
                                                Standard Chartered Bank
                                            @elseif($mode == 'yes_bank')
                                                YES Bank
                                            @elseif($mode == 'kotak_bank')
                                                Kotak Mahindra Bank
                                            @else
                            ...
                            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                <thead class="bg-gray-50 dark:bg-gray-700">
                                    <tr>
                                        ...
                                        <th class="px-6 py-3 text-right text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">Unused Amount</th>
                                ...
                                <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                    @foreach($payments as $payment)
                                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="text-sm text-gray-900 dark:text-white">{{ $payment->supplier->company_name }}</div>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-white">
                                                {{ $payment->bill_number ?? '-' }}
                                            </td>
