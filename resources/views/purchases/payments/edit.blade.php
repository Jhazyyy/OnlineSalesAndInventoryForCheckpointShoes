    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <form method="POST" action="{{ route('purchases.payments.update', $payment->payment_id) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <div class="mt-1 relative">
                                    ...
                                    <input type="number" id="bank_charges" name="bank_charges" 
                                           value="{{ old('bank_charges', $payment->bank_charges) }}"
                                           step="0.01"
                            ...
                            <div>
                                ...
                                <select id="payment_mode" name="payment_mode" 
                                    ...
                                    <option value="icici_bank" {{ old('payment_mode', $payment->payment_mode) == 'icici_bank' ? 'selected' : '' }}>ICICI Bank</option>
                                    <option value="standard_chartered" {{ old('payment_mode', $payment->payment_mode) == 'standard_chartered' ? 'selected' : '' }}>Standard Chartered Bank</option>
                                    <option value="yes_bank" {{ old('payment_mode', $payment->payment_mode) == 'yes_bank' ? 'selected' : '' }}>YES Bank</option>
                                    <option value="kotak_bank" {{ old('payment_mode', $payment->payment_mode) == 'kotak_bank' ? 'selected' : '' }}>Kotak Mahindra Bank</option>
                            ...
                            <div>
                                ...
                                <input type="text" id="bill_number" name="bill_number" 
                                       value="{{ old('bill_number', $payment->bill_number) }}"
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                            </div>
                        ...
                        <div class="mt-6">
                            ...
                            <textarea id="notes" name="notes" rows="3"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">{{ old('notes', $payment->notes) }}</textarea>
                        </div>
