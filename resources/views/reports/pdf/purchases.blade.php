    ...
    <div class="summary">
        ...
        <div class="card">
            ...
            <div style="font-size:18px; font-weight:700">
                ₱{{ number_format($report['summary']['total_amount'] ?? 0, 2) }}</div>
        </div>
        <div class="card">
            <div class="small muted">Total Paid</div>
            <div style="font-size:18px; font-weight:700">₱{{ number_format($report['summary']['total_paid'] ?? 0, 2) }}
            </div>
        </div>
        <div class="card">
            <div class="small muted">Total Due</div>
            <div style="font-size:18px; font-weight:700">₱{{ number_format($report['summary']['total_due'] ?? 0, 2) }}
            </div>
        </div>
    </div>
