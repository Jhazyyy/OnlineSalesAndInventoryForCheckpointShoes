                ...
                <div class="bg-white dark:bg-gray-800 border dark:border-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-2xl font-bold text-indigo-600 dark:text-indigo-400">{{ $stats['new_this_month'] }}</p>
                        </div>
                ...
                <div class="p-6">
                    <form method="GET" action="{{ route('user-management.index') }}" class="space-y-4">
                        ...
                        <div class="flex flex-col md:flex-row md:items-end md:space-x-6">
                            ...
                            <!-- Active Filter -->
                            <div class="mt-4 md:mt-0">
                                <label for="is_active" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Active</label>
                            ...
                            <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                @forelse($users as $user)
                                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-{{ $user->role_color }}-100 text-{{ $user->role_color }}-800">
                                                {{ ucfirst($user->role) }}
                                            </span>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
