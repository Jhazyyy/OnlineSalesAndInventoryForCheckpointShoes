<x-app-layout>
    <div class="py-6" x-data="{ showToast: false, toastMessage: '', toastType: 'success' }" x-init="@if (session('success')) showToast = true;
        ...
        @elseif($errors->any())
            ...
            toastType = 'error';
            setTimeout(() => showToast = false, 5000); @endif">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
                ...
                <div id="receipt" class="bg-white dark:bg-gray-800 shadow-lg sm:rounded-lg overflow-hidden">
                    ...
                    <div class="bg-gradient-to-r from-blue-600 to-blue-700 text-white p-6 text-center">
                        ...
                        <div class="mt-4 pt-4 border-t border-blue-500">
                            ...
                            <p class="text-sm mt-1">{{ $order->order_date->format('F d, Y') }}</p>
                            <p class="text-xs mt-1 opacity-90">{{ $order->order_date->format('h:i A') }}</p>
                        </div>
                    </div>
                    ...
                    <div class="p-8">
                        ...
                        <div class="mb-6 pb-6 border-b border-gray-200 dark:border-gray-700">
                            <h3 class="text-sm font-semibold text-gray-500 dark:text-gray-400 uppercase mb-2">Customer
                            </h3>
                            <div class="space-y-1">
                        ...
                        <!-- Items -->
                        <div class="mb-6 pb-6 border-b border-gray-200 dark:border-gray-700">
                            <h3 class="text-sm font-semibold text-gray-500 dark:text-gray-400 uppercase mb-2">Items</h3>
                            <table class="w-full">
                                <thead>
                                    ...
                                    <div class="flex justify-between text-sm">
                                        <div class="flex flex-col">
                                            ...
                                            @if ($order->discountRule)
                                                <span
                                                    class="text-xs text-gray-500 dark:text-gray-500">{{ $order->discountRule->name }}</span>
                                            @endif
                                        </div>
                                        <span
                                            class="text-red-600 dark:text-red-400">-₱{{ number_format($order->discount_amount, 2) }}</span>
                                    </div>
                                @endif
                                <!-- Tax Line - Always Visible -->
                                <div
                                    class="flex justify-between text-sm border-t border-gray-300 dark:border-gray-600 pt-2 mt-2">
                                    <div class="flex flex-col">
                                        <span class="font-medium text-gray-700 dark:text-gray-300">Tax:</span>
                                        @if ($order->taxRule)
                                            <span
                                                class="text-xs text-gray-500 dark:text-gray-500">{{ $order->taxRule->name }}</span>
                                        @else
                                            <span class="text-xs text-gray-400 dark:text-gray-600">No tax applied</span>
                                        @endif
                                    </div>
                                    <span
                                        class="font-semibold {{ $order->tax_amount > 0 ? 'text-indigo-600 dark:text-indigo-400' : 'text-gray-500 dark:text-gray-500' }}">
                                        ₱{{ number_format($order->tax_amount ?? 0, 2) }}
                                    </span>
                                </div>
                                <div
                                    class="flex justify-between text-xl font-bold pt-2 border-t border-gray-300 dark:border-gray-600">
                                    <span class="text-gray-900 dark:text-white">Total:</span>
                                    <span
                                        class="text-gray-900 dark:text-white">₱{{ number_format($order->total_amount, 2) }}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-6 pb-6 border-b border-gray-200 dark:border-gray-700">
                            ...
                            <div class="grid grid-cols-2 gap-4 text-sm">
                                <div>
                                    ...
                                    <span
                                        class="ml-2 font-medium text-gray-900 dark:text-white capitalize">{{ str_replace('_', ' ', $order->payment_method) }}</span>
                                </div>
                                <div>
                                ...
                                @if ($amountReceived)
                                    <div>
                                        ...
                                        <span
                                            class="ml-2 font-medium text-gray-900 dark:text-white">₱{{ number_format($amountReceived, 2) }}</span>
                                    </div>
                                    @if ($change >= 0)
                                        <div>
                                            <span class="text-gray-600 dark:text-gray-400">Change:</span>
                                            <span
                                                class="ml-2 font-medium text-green-600 dark:text-green-400">₱{{ number_format($change, 2) }}</span>
                                        </div>
                                    @else
                                        <div>
                                            <span class="text-gray-600 dark:text-gray-400">Remaining Balance:</span>
                                            <span
                                                class="ml-2 font-medium text-red-600 dark:text-red-400">₱{{ number_format(abs($change), 2) }}</span>
                                        </div>
                                    @endif
                                @endif
                            </div>
                            ...
                            @if ($order->payment_method === 'bank_transfer')
                                ...
                                @if ($bankPayment)
                                    <div
                                        class="mt-4 p-4 bg-blue-50 dark:bg-blue-900 rounded-md border border-blue-200 dark:border-blue-700">
                                        ...
                                        <div class="space-y-2 text-sm">
                                            <div class="flex justify-between">
                                                ...
                                                <span
                                                    class="font-medium text-blue-900 dark:text-blue-200">{{ $bankPayment->bank_name }}</span>
                                            </div>
                                            <div class="flex justify-between">
                                                <span class="text-blue-700 dark:text-blue-300">Reference Number:</span>
                                                <span
                                                    class="font-medium text-blue-900 dark:text-blue-200 font-mono">{{ $bankPayment->reference_no }}</span>
                                            </div>
                                            <div class="flex justify-between">
                                            ...
                                            @if ($bankPayment->status === 'pending')
                                                <div class="mt-2 pt-2 border-t border-blue-200 dark:border-blue-700">
                                                    <p class="text-xs text-blue-700 dark:text-blue-300">
                                                        ⏳ Payment proof is pending admin confirmation. Order will be
                                ...
                                @else
                                    <div
                                        class="mt-4 p-3 bg-yellow-50 dark:bg-yellow-900 rounded-md border border-yellow-200 dark:border-yellow-700">
                                    ...
                                    <div
                                        ...
                                        <div class="flex items-start justify-between mb-3">
                                            <div class="flex items-center">
                                                <svg class="w-6 h-6 text-blue-600 dark:text-blue-400 mr-2"
                                        ...
                                        <div class="p-3 bg-white dark:bg-gray-900 rounded-lg shadow-sm border border-blue-200 dark:border-blue-700">
                                            <img src="{{ asset('storagegcash_qr.png') }}" 
                                                 alt="GCash QR Code" 
                                        ...
                                        <div class="space-y-2 text-sm">
                                            <div class="flex justify-between">
                                                <span class="text-blue-700 dark:text-blue-300">Reference Number:</span>
                                                <span
                                                    class="font-medium text-blue-900 dark:text-blue-200 font-mono">{{ $gcashPayment->reference_number }}</span>
                                            </div>
                                            <div class="flex justify-between">
                                                <span class="text-blue-700 dark:text-blue-300">Amount:</span>
                                                <span
                                                    class="font-medium text-blue-900 dark:text-blue-200">₱{{ number_format($gcashPayment->amount, 2) }}</span>
                                            </div>
                                            <div class="flex justify-between">
                                                <span class="text-blue-700 dark:text-blue-300">Payment Date:</span>
                                                <span
                                                    class="font-medium text-blue-900 dark:text-blue-200">{{ $gcashPayment->payment_date?->format('M d, Y h:i A') ?? 'N/A' }}</span>
                                            </div>
                                            @if ($gcashPayment->status === 'verified' && $gcashPayment->verified_at)
                                                <div class="mt-2 pt-2 border-t border-blue-200 dark:border-blue-700">
                                                    <p class="text-xs text-green-700 dark:text-green-300">
                                                        ✓ Payment verified on
                                                        {{ $gcashPayment->verified_at->format('M d, Y h:i A') }}
                                                    </p>
                                                </div>
                                            @endif
                                        </div>
                        ...
                        @if (in_array($order->payment_status, ['partial', 'pending']))
                            <div class="mb-6 pb-6 border-b border-gray-200 dark:border-gray-700 print:hidden">
                                <div
                                    ...
                                    <h3
                                        class="text-sm font-semibold text-yellow-800 dark:text-yellow-400 uppercase mb-3 flex items-center">
                                    ...
                                    <form action="{{ route('pos.complete-payment', $order->order_id) }}"
                                        ...
                                        <div>
                                            ...
                                            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                                                Remaining balance:
                                                ₱{{ number_format($order->total_amount - ($order->amount_received ?? 0), 2) }}
                                            </p>
                                        </div>
                        ...
                        <!-- Footer -->
                        <div
                            class="text-center text-xs text-gray-500 dark:text-gray-400 mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
                            <p>Thank you for your purchase!</p>
                            <p class="mt-1">For inquiries, please contact us at +639603316595 or visit our Facebook
                                Page.</p>
                ...
                <!-- Toast Notification -->
                <div x-show="showToast" x-cloak x-transition:enter="transform ease-out duration-300 transition"
