<x-app-layout>
    <div class="py-6">
        <div class="w-full mx-auto sm:px-6 lg:px-8">
                ...
                <div class="p-6">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                        ...
                        <div class="flex flex-col sm:flex-row gap-3 mt-4 sm:mt-0">
                            <a href="{{ route('inventory.purchase-receives.analytics') }}" 
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6">
                    <form method="GET" action="{{ route('inventory.purchase-receives.index') }}" class="space-y-4">
                                        ...
                                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="text-sm font-medium text-gray-900 dark:text-white">
                                                    <a href="{{ route('inventory.purchase-receives.show', $receive->receive_id) }}" class="text-blue-600 hover:text-blue-900">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="text-sm text-gray-900 dark:text-white">
                                                    @if($receive->purchaseOrder)
                                                        <a href="{{ route('inventory.purchase-orders.show', $receive->purchase_order_id) }}" class="text-blue-600 hover:text-blue-900">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                <div class="flex space-x-2">
                                                    ...
                                                    @if($receive->canBeCancelled())
                                                        <form action="{{ route('inventory.purchase-receives.destroy', $receive->receive_id) }}" 
