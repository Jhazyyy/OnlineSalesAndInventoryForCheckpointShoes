                ...
                @foreach($adjustments as $adjustment)
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                        ...
                        <td class="px-4 py-3 text-sm text-gray-500 dark:text-gray-400">
                            @if($adjustment->notes)
                                <div class="max-w-xs truncate" title="{{ $adjustment->notes }}">
                                    {{ $adjustment->notes }}
                                </div>
                            @else
...
@else
    <div class="text-center py-12">
        ...
        <h3 class="mt-2 text-sm font-medium text-gray-900 dark:text-white">No adjustment history</h3>
        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">This product has no stock adjustment history yet.</p>
    </div>
@endif
