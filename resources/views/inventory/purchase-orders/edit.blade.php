                    ...
                    <div class="p-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="order_number" name="order_number" type="text" class="mt-1 block w-full bg-gray-50"
                            ...
                            <div class="md:col-span-2">
                                ...
                                <x-text-input id="reference_number" name="reference_number" type="text" class="mt-1 block w-full"
                                    :value="old('reference_number', $order->reference_number)" placeholder="Optional reference number" />
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-6 gap-4 items-end">
                                    ...
                                    <div>
                                        ...
                                        <input type="number" name="items[{{ $index }}][quantity_ordered]"
                                            ...
                                            min="1" value="{{ old("items.{$index}.quantity_ordered", $item->quantity_ordered) }}" required>
                                    </div>
                                    <div>
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <x-text-input id="shipping_amount" name="shipping_amount" type="number" step="0.01"
                                        class="mt-1 block w-full" :value="old('shipping_amount', $order->shipping_amount)" />
                                ...
                                <div>
                                    ...
                                    <x-text-input id="discount_amount" name="discount_amount" type="number" step="0.01"
                                        class="mt-1 block w-full" :value="old('discount_amount', $order->discount_amount)" />
