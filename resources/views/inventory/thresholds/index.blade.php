                ...
                <div class="p-6">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                        <div>
                            ...
                            <p class="text-gray-600 dark:text-gray-400">Manage product reorder levels and stock alerts
                            </p>
                        </div>
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <div class="text-2xl font-bold text-gray-900 dark:text-white">
                                    {{ number_format($stats['products_with_thresholds']) }}</div>
                                <div class="text-xs text-gray-500 dark:text-gray-400">
                                    {{ $stats['threshold_coverage'] }}% coverage</div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <div class="text-2xl font-bold text-gray-900 dark:text-white">
                                    {{ number_format($stats['active_alerts']) }}</div>
                                <div class="text-xs text-red-500">{{ number_format($stats['critical_alerts']) }}
                                    critical</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <div class="text-2xl font-bold text-gray-900 dark:text-white">
                                    {{ number_format($stats['auto_reorder_enabled']) }}</div>
                            ...
                            <div>
                                ...
                                <select id="sort" name="sort"
                                    ...
                                    <option value="product_name"
                                        {{ request('sort') == 'product_name' ? 'selected' : '' }}>Product Name</option>
                                    ...
                                    <option value="reorder_level"
                                        {{ request('sort') == 'reorder_level' ? 'selected' : '' }}>Reorder Level
                                    </option>
                                    <option value="critical_level"
                                        {{ request('sort') == 'critical_level' ? 'selected' : '' }}>Critical Level
                                    </option>
                                </select>
                            </div>
                                    ...
                                    @foreach ($products as $product)
                                        ...
                                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                ...
                                                @endphp
                                                <span
                                                    class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full {{ $statusColors[$statusClass] ?? 'bg-gray-100 text-gray-800' }}">
                                                    {{ $statusText }}
                                                </span>
                                            </td>
                                            <td
                    ...
                    @else
                        <div class="text-center py-12">
                            <svg class="mx-auto h-12 w-12 text-gray-400" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M20 13V6a2 2 0 00-2-2H6a2 2 0 00-2 2v7m16 0v5a2 2 0 01-2 2H6a2 2 0 01-2-2v-5m16 0h-2M4 13h2m0 0l3-3m-3 3l3 3M15 8h3">
                                </path>
                            </svg>
        ...
        <div
            ...
            <div class="mt-3">
                ...
                <div class="flex items-center justify-between pb-3 border-b dark:border-gray-700">
                    ...
                    <button onclick="closeEditThresholdModal()"
                ...
                <form id="editThresholdForm" method="POST">
                    ...
                    <div class="mt-4 space-y-4">
                        ...
                        <div class="bg-gray-50 dark:bg-gray-900 rounded-lg p-4">
                            <h4 class="text-sm font-medium text-gray-900 dark:text-white mb-2" id="modalProductName">
                                Loading...</h4>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                            ...
                            <div>
                                <label for="modal_critical_level"
                                    class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                    Critical Level
                                </label>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div>
                                <label for="modal_economic_order_quantity"
                                    class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                    Economic Order Quantity
                                </label>
                                <input type="number" min="1" id="modal_economic_order_quantity"
                                    name="economic_order_quantity"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                            </div>
                            <div>
                                <label for="modal_lead_time_days"
                                    class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                    Lead Time (days)
                                </label>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <label class="inline-flex items-center">
                                ...
                                <input type="checkbox" id="modal_auto_reorder_enabled" name="auto_reorder_enabled"
                                    value="1"
                            ...
                            <label class="inline-flex items-center">
                                ...
                                <input type="checkbox" id="modal_threshold_alerts_enabled"
                        ...
                        <div
                            ...
                            <div class="flex">
                                ...
                                <div class="ml-3">
                                    <h3 class="text-sm font-medium text-blue-800 dark:text-blue-300">Threshold
                                        Guidelines</h3>
                                    <p class="mt-2 text-sm text-blue-700 dark:text-blue-400">
                                        Set appropriate threshold levels to manage inventory efficiently. The system
                                        will alert you when stock levels reach these thresholds.
                                    </p>
                                </div>
                            </div>
                        </div>
        ...
        function openEditThresholdModal(productId) {
            ...
            fetch(`/inventory/thresholds/${productId}/edit`, {
                ...
                .then(data => {
                    ...
                    document.getElementById('modal_economic_order_quantity').value = data.product
                        .economic_order_quantity || '';
                    document.getElementById('modal_lead_time_days').value = data.product.lead_time_days || '';
                    document.getElementById('modal_auto_reorder_enabled').checked = data.product.auto_reorder_enabled ||
                        false;
                    document.getElementById('modal_threshold_alerts_enabled').checked = data.product
