                    ...
                    <form method="POST" action="{{ route('inventory.product_stocks.update', $stock) }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                                ...
                                <div class="space-y-3">
                                    <div>
                                        ...
                                        <div
                                            class="mt-1 p-2 bg-gray-100 dark:bg-gray-600 rounded-md text-gray-800 dark:text-gray-200">
                                            {{ $stock->product->product_name ?? 'N/A' }} -
                                            {{ $stock->product->product_brand ?? 'N/A' }}
                                        </div>
                                    </div>
                                    <div>
                                        <label
                            ...
                            <div class="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                                ...
                                <div class="space-y-3">
                                    <div>
                                        <label
                                            class="block text-sm font-medium text-gray-700 dark:text-gray-300">Movement
                                            Type</label>
                                        <div
                                            class="mt-1 p-2 bg-gray-100 dark:bg-gray-600 rounded-md text-gray-800 dark:text-gray-200">
                        ...
                        <div class="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="quantity_change" name="quantity_change" type="number"
                                    class="mt-1 block w-full" :value="old('quantity_change', $stock->quantity_change)"
                                    required />
                                <x-input-error class="mt-2" :messages="$errors->get('quantity_change')" />
                                <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Positive for increase, negative
                                    for decrease</p>
                            </div>
                            ...
                            <div>
                                ...
                                <x-text-input id="unit_cost" name="unit_cost" type="number" step="0.01"
                                    class="mt-1 block w-full" :value="old('unit_cost', $stock->unit_cost)" />
                        ...
                        <div class="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="bg-blue-50 dark:bg-blue-900 p-4 rounded-lg">
                                <h4 class="text-md font-semibold mb-2 text-blue-800 dark:text-blue-200">New Quantity
                                    After</h4>
                            ...
                            <div class="bg-green-50 dark:bg-green-900 p-4 rounded-lg">
                                <h4 class="text-md font-semibold mb-2 text-green-800 dark:text-green-200">Total Value
                                </h4>
                        ...
                        <div class="mt-8 flex items-center justify-end space-x-4">
                            <a href="{{ route('inventory.product_stocks.show', $stock) }}"
