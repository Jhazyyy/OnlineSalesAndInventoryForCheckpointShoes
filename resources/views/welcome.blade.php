...
<body class="dark:bg-gray-900 text-gray-900 flex p-6 lg:p-4 items-center min-h-screen flex-col">
    <header class="w-full lg:max-w-7xl text-sm mb-6">
        @if (Route::has('login'))
                ...
                <div class="flex items-center gap-3 space-y-4 lg:space-y-0 lg:gap-4">
                    @auth
                        <a href="{{ url('/dashboard') }}"
                            class="inline-flex px-5 py-1.5 dark:text-white border-gray-500 hover:border-black border text-black dark:border-gray-500 dark:hover:border-blue-400 rounded-sm text-sm leading-normal">
                            Back to Dashboard
                        </a>
                    @else
                        <a href="{{ route('login') }}"
                        ...
                        @if (Route::has('register'))
                            {{-- <a href="{{ route('register') }}"
                                class=" flex-inline items-center px-4 py-2 bg-blue-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-blue-700 focus:bg-blue-700 active:bg-blue-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150">
                                Register
                            </a> --}}
                        @endif
                    @endauth
    ...
    <div class="flex flex-row items-center lg:items-stretch w-full lg:max-w-7xl dark:text-white font-medium">
        <div class="mt-10">
            <h1 class="font-bold text-5xl mb-4">Welcome to Checkpoint Shoes <br> Inventory Management</h1>
            ...
            <div
                class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 pt-6 lg:max-w-3xl lg:gap-4 overflow-hidden rounded-lg bg-red-100 dark:bg-red-900 bg-opacity-50 dark:bg-opacity-50 mt-4">
            ...
            <div class="flex lg:flex-row dark:text-white mt-2">
                <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Repudiandae maxime illo porro natus
                    adipisci beatae quasi voluptas commodi, maiores mollitia error illum, ad optio laudantium possimus
                    sunt cupiditate tempora vel.</p>
            </div>
