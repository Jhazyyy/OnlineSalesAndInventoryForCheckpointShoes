                            ...
                            <div class="space-y-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-900 dark:text-white">
                                        {{ $stockName->created_at->format('M d, Y') }}
                                    </p>
                                </div>
                                <div>
                                    <span class="text-sm font-medium text-gray-700 dark:text-gray-300">Last
                                        Updated:</span>
                                    <p class="text-gray-900 dark:text-white">
                                        {{ $stockName->updated_at->format('M d, Y') }}
                                    </p>
                                </div>
                            </div>
                        </div>
            ...
            @else
                <div
                    ...
                    <div class="p-6 text-center">
                        ...
                        <p class="text-gray-500 dark:text-gray-400 mb-4">This stock name doesn't have any products yet.
                        </p>
