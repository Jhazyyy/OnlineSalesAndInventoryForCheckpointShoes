    ...
    <div class="py-2">
        <div class="max-w-full mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg mb-2">
                <div class="p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            <h2 class="text-2xl font-bold text-gray-900 dark:text-white">Edit Stock Name</h2>
                            <p class="text-gray-600 dark:text-gray-400">Update stock name information</p>
                        </div>
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <form method="POST" action="{{ route('master_data.stock_names.update', $stockName) }}"
                        class="space-y-6">
                        @csrf
                        @method('PUT')
                        ...
                        <div>
                            ...
                            <textarea id="description" name="description" rows="3" maxlength="500"
                                ...
                                placeholder="Enter stock name description (optional)">{{ old('description', $stockName->description) }}</textarea>
                        ...
                        <div>
                            <div class="flex items-center">
                                <input type="checkbox" id="is_active" name="is_active" value="1"
                                    {{ old('is_active', $stockName->is_active) ? 'checked' : '' }}
