        ...
        <div class="max-w-full mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            <h2 class="text-2xl font-bold text-gray-900 dark:text-white">Create New Brand</h2>
                            <p class="text-gray-600 dark:text-gray-400">Add a new brand to the system</p>
                        </div>
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    <form method="POST" action="{{ route('master_data.brands.store') }}" enctype="multipart/form-data"
                        class="space-y-6">
                        @csrf
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <!-- Brand Code -->
                                <div>
                                    <x-input-label for="brand_code" :value="__('Brand Code')" />
                                    <x-text-input id="brand_code" name="brand_code" type="text"
                                        class="mt-1 block w-full" :value="old('brand_code')" required maxlength="20"
                                        placeholder="e.g., BRAND-001" />
                                    <x-input-error class="mt-2" :messages="$errors->get('brand_code')" />
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-sm text-gray-500">Inactive brands won’t be available for new products.
                            </p>
                        </div>

                        <!-- Optional Logo Upload (commented out for now) -->
{{--                         
                        <div>
                            <x-input-label for="image" :value="__('Brand Image')" />
                            ...
                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">PNG, JPG, or GIF. Max size: 2MB.</p>
                        </div>
                        --}}
