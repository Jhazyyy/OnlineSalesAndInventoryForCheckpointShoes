    ...
    <div class="py-2">
        <div class="w-full mx-auto sm:px-6 lg:px-8">
            ...
            <div
                class="bg-white dark:bg-gray-800 border dark:border-gray-800 overflow-hidden shadow-sm sm:rounded-lg mb-2">
                <div class="p-6">
                    <form method="GET" action="{{ route('master_data.categories.index') }}" class="space-y-4">
                        <!-- Inputs Row -->
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 text-sm text-gray-500 dark:text-gray-300">
                                            <div class="max-w-xs truncate">
                                                {{ $category->description ?: 'No description' }}</div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                                            ...
                                            {{-- <form action="{{ route('master_data.categories.destroy', $category) }}"
