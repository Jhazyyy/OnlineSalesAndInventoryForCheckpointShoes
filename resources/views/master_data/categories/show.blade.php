            ...
            <div
                ...
                <div class="p-6">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                        <div>
                            <h2 class="text-2xl font-bold text-gray-900 dark:text-white">Category Details</h2>
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <div class="space-y-3">
                                <div>
                                    <span class="text-sm font-medium text-gray-700 dark:text-gray-300">Category
                                        Code:</span>
                                    <p class="text-gray-900 dark:text-white">{{ $category->category_code }}</p>
                                </div>
                                <div>
                                    <span class="text-sm font-medium text-gray-700 dark:text-gray-300">Category
                                        Name:</span>
                            ...
                            <div class="space-y-3">
                                <div>
                                    <span class="text-sm font-medium text-gray-700 dark:text-gray-300">Total
                                        Products:</span>
                                    <p class="text-gray-900 dark:text-white">{{ number_format($productsCount) }}</p>
                                </div>
                                <div>
                                ...
                                <div>
                                    <span class="text-sm font-medium text-gray-700 dark:text-gray-300">Last
                                        Updated:</span>
                                    <p class="text-gray-900 dark:text-white">
                                        {{ $category->updated_at ? $category->updated_at->format('M d, Y') : 'N/A' }}
                                    </p>
                                </div>
                            </div>
                        </div>
