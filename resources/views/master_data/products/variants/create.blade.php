    ...
    <div class="py-6">
        <div class="w-full mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                        <div>
                            <h2 class="text-2xl font-bold text-gray-900 dark:text-white">Add New Variant</h2>
                            <p class="text-gray-600 dark:text-gray-400">
                                Create a new variant for {{ $product->product_name }}
                            </p>
                        </div>
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <form method="POST" action="{{ route('master_data.products.variants.store', $product) }}"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" id="variant_sku" name="variant_sku"
                                        value="{{ old('variant_sku') }}" required
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="md:w-1/3">
                                ...
                                <input type="number" id="critical_level" name="critical_level"
                                    value="{{ old('critical_level') }}" min="0"
                                    placeholder="Optional"
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <textarea id="notes" name="notes" rows="3"
                                    ...
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white @error('notes') border-red-500 @enderror">{{ old('notes') }}</textarea>
                                @error('notes')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
