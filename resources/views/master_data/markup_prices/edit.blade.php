        ...
        <div class="max-w-full mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg mb-2">
                <div class="p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            <h2 class="text-2xl font-bold text-gray-900 dark:text-white">Edit Markup Price</h2>
                            <p class="text-gray-600 dark:text-gray-400">Update markup pricing configuration</p>
                        </div>
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    <form method="POST" action="{{ route('master_data.markup_prices.update', $markupPrice) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <input type="text" id="name" name="name" value="{{ old('name', $markupPrice->name) }}" required
                            ...
                            <div>
                                ...
                                <textarea id="description" name="description" rows="3"
                                    ...
                                    class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white @error('description') border-red-500 @enderror">{{ old('description', $markupPrice->description) }}</textarea>
                                @error('description')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="number" id="markup_percentage" name="markup_percentage" 
                                        value="{{ old('markup_percentage', $markupPrice->markup_percentage) }}" required step="0.01" min="0" max="1000"
                            ...
                            <div>
                                <label class="flex items-center">
                                    <input type="checkbox" name="is_active" value="1" {{ old('is_active', $markupPrice->is_active) ? 'checked' : '' }}
