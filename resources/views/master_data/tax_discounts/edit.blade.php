        ...
        <div class="max-w-full mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    <form method="POST" action="{{ route('master_data.tax_discounts.update', $taxDiscount) }}"
                        class="space-y-6" id="taxDiscountForm">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-2">
                                ...
                                <div>
                                    ...
                                    <x-text-input id="code" name="code" type="text" class="mt-1 block w-full"
                                        :value="old('code', $taxDiscount->code)" required maxlength="20"
                                        placeholder="e.g., TAX-VAT or DISC-10" />
                                    <x-input-error class="mt-2" :messages="$errors->get('code')" />
                                    <p class="mt-1 text-sm text-gray-500">Unique code. Use letters, numbers, dashes, or
                                        underscores.</p>
                                </div>
                                ...
                                <div>
                                    ...
                                    <select id="type" name="type" required
                                        ...
                                        <option value="tax"
                                            {{ old('type', $taxDiscount->type) === 'tax' ? 'selected' : '' }}>Tax
                                        </option>
                                        <option value="discount"
                                            {{ old('type', $taxDiscount->type) === 'discount' ? 'selected' : '' }}>
                                            Discount</option>
                                    </select>
                                ...
                                <div>
                                    ...
                                    <select id="calculation_method" name="calculation_method" required
                                        ...
                                        <option value="percentage"
                                            {{ old('calculation_method', $taxDiscount->calculation_method) === 'percentage' ? 'selected' : '' }}>
                                            Percentage</option>
                                        <option value="fixed"
                                            {{ old('calculation_method', $taxDiscount->calculation_method) === 'fixed' ? 'selected' : '' }}>
                                            Fixed Amount</option>
                                    </select>
                                ...
                                <div id="rate_field">
                                    ...
                                    <p class="mt-1 text-sm text-gray-500">Enter percentage value (e.g., 12.5 for 12.5%)
                                    </p>
                                </div>
                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <select id="applies_to" name="applies_to" required
                                        class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm">
                                        <option value="all"
                                            {{ old('applies_to', $taxDiscount->applies_to) === 'all' ? 'selected' : '' }}>
                                            All Products</option>
                                        <option value="specific"
                                            {{ old('applies_to', $taxDiscount->applies_to) === 'specific' ? 'selected' : '' }}>
                                            Specific Categories/Products</option>
                                    </select>
                                ...
                                <div id="specific_fields" style="display: none;">
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        ...
                                        <div>
                                            ...
                                            <select id="applicable_categories" name="applicable_categories[]" multiple
                                                size="5"
                                                class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <x-text-input id="valid_from" name="valid_from" type="date"
                                        class="mt-1 block w-full" :value="old(
                                            'valid_from',
                                            $taxDiscount->valid_from ? $taxDiscount->valid_from->format('Y-m-d') : '',
                                        )" />
                                ...
                                <div>
                                    ...
                                    <x-text-input id="valid_to" name="valid_to" type="date"
                                        class="mt-1 block w-full" :value="old(
                                            'valid_to',
                                            $taxDiscount->valid_to ? $taxDiscount->valid_to->format('Y-m-d') : '',
                                        )" />
