        ...
        <div class="max-w-full mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    <form method="POST" action="{{ route('master_data.tax_discounts.store') }}" class="space-y-6"
                        id="taxDiscountForm">
                        @csrf
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <select id="type" name="type" required
                                        ...
                                        <option value="tax" {{ old('type') === 'tax' ? 'selected' : '' }}>Tax
                                        </option>
                                ...
                                <div>
                                    ...
                                    <select id="calculation_method" name="calculation_method" required
                                        ...
                                        <option value="percentage"
                                            {{ old('calculation_method', 'percentage') === 'percentage' ? 'selected' : '' }}>
                                            Percentage</option>
                                        <option value="fixed"
                                            {{ old('calculation_method') === 'fixed' ? 'selected' : '' }}>Fixed Amount
                                        </option>
                                    </select>
                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <select id="applies_to" name="applies_to" required
                                        class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm">
                                        <option value="all"
                                            {{ old('applies_to', 'all') === 'all' ? 'selected' : '' }}>All Products
                                        </option>
                                        <option value="specific"
                                            {{ old('applies_to') === 'specific' ? 'selected' : '' }}>Specific
                                            Categories/Products</option>
                                    </select>
