        ...
        <div class="max-w-full mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    <form method="POST" action="{{ route('master_data.tax_discounts.store') }}" class="space-y-6" id="taxDiscountForm">
                        @csrf
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <x-text-input id="code" name="code" type="text"
                                        class="mt-1 block w-full" :value="old('code')" required maxlength="20"
                                ...
                                <div>
                                    ...
                                    <x-text-input id="name" name="name" type="text" class="mt-1 block w-full"
                                        :value="old('name')" required maxlength="100" placeholder="Enter name" />
                                ...
                                <div>
                                    ...
                                    <select id="applicable_for" name="applicable_for" required
                                        ...
                                        <option value="customer" {{ old('applicable_for') === 'customer' ? 'selected' : '' }}>Customer (Sales Orders)</option>
                                    </select>
                                ...
                                <div>
                                    ...
                                    <select id="calculation_method" name="calculation_method" required
                                        class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm">
                                        <option value="percentage" {{ old('calculation_method', 'percentage') === 'percentage' ? 'selected' : '' }}>Percentage</option>
                                        <option value="fixed" {{ old('calculation_method') === 'fixed' ? 'selected' : '' }}>Fixed Amount</option>
                                    </select>
                                ...
                                <div id="rate_field">
                                    ...
                                    <x-text-input id="rate" name="rate" type="number" step="0.0001"
                                        class="mt-1 block w-full" :value="old('rate')" min="0" max="100"
                                ...
                                <div id="fixed_amount_field" style="display: none;">
                                    ...
                                    <x-text-input id="fixed_amount" name="fixed_amount" type="number" step="0.01"
                                        class="mt-1 block w-full" :value="old('fixed_amount')" min="0"
                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <select id="applies_to" name="applies_to" required
                                        class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm">
                                        <option value="all" {{ old('applies_to', 'all') === 'all' ? 'selected' : '' }}>All Products</option>
                                        <option value="specific" {{ old('applies_to') === 'specific' ? 'selected' : '' }}>Specific Categories/Products</option>
                                    </select>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <x-text-input id="valid_from" name="valid_from" type="date"
                                        class="mt-1 block w-full" :value="old('valid_from')" />
                                ...
                                <div>
                                    ...
                                    <x-text-input id="valid_to" name="valid_to" type="date"
                                        class="mt-1 block w-full" :value="old('valid_to')" />
