    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6" enctype="multipart/form-data">
        ...
        {{-- <div>
            ...
            <input id="profile_photo" name="profile_photo" type="file" accept="image/*" 
                class="mt-1 block w-full text-sm text-gray-900 dark:text-gray-100 border border-gray-300 dark:border-gray-600 rounded-lg cursor-pointer bg-gray-50 dark:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500" />
        ...
        <div>
            ...
            <x-text-input id="name" name="name" type="text" class="mt-1 block w-full" :value="old('name', $user->name)" autofocus autocomplete="name" disabled readonly/>
        ...
        <div>
            <x-input-label for="password_display" :value="__('Password')" />
            <x-text-input id="password_display" type="password" class="mt-1 block w-full" value="••••••••" disabled readonly />
            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Use the password update section below to change your password</p>
        </div>
        ...
        <div class="flex items-center gap-4">
            ...
            <button type="button" onclick="window.location.href='{{ route('dashboard') }}'" class="inline-flex items-center px-6 py-2 bg-gray-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 focus:bg-gray-700 active:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 transition ease-in-out duration-150">
                {{ __('Cancel') }}
            </button>
