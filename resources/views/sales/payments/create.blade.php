    ...
    <div class="py-6">
        <div class="max-w-full mx-auto sm:px-6 lg:px-8">
                ...
                <div class="p-6">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                        <div>
                            ...
                            <p class="text-gray-600 dark:text-gray-400">Record a new payment from a customer</p>
                        </div>
                        <div>
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <form method="POST" action="{{ route('sales.payments.store') }}" class="space-y-6">
                        @csrf
                                ...
                                <select id="customer_id" name="customer_id" required 
                                    ...
                                    @foreach($customers as $customer)
                                        <option value="{{ $customer->customer_id }}" 
                                                {{ old('customer_id', $selectedCustomer) == $customer->customer_id ? 'selected' : '' }}>
                                ...
                                <select id="order_id" name="order_id" 
                                    ...
                                    @foreach($salesOrders as $order)
                                        <option value="{{ $order->order_id }}" 
                                                ...
                                                {{ old('order_id', $selectedOrder) == $order->order_id ? 'selected' : '' }}>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            orderSelect.addEventListener('change', function () {
                ...
                if (selectedOption.dataset.amount && !amountInput.value) {
