            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                        <div>
                            <h2 class="text-2xl font-bold text-gray-900 dark:text-white">Sales Order
                    ...
                    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    <label class="block text-sm font-medium text-gray-500 dark:text-gray-400">Order
                                        Number</label>
                                ...
                                {{-- <div>
                                    <label class="block text-sm font-medium text-gray-500 dark:text-gray-400">Required
                                        Date</label>
                                    <p class="text-sm text-gray-900 dark:text-white">
                                        {{ $order->required_date ? $order->required_date->format('M d, Y') : 'Not specified' }}
                                        @if ($order->is_overdue)
                                            <span
                                                class="ml-2 px-2 py-1 text-xs font-semibold bg-red-100 text-red-800 rounded-full">OVERDUE</span>
                                        @endif
                                    </p>
                                </div> --}}
                                <div>
                                    <label class="block text-sm font-medium text-gray-500 dark:text-gray-400">Completed
                                        Date</label>
                                    <p class="text-sm text-gray-900 dark:text-white">
                                ...
                                {{-- <div>
                                    <label
                                        class="block text-sm font-medium text-gray-500 dark:text-gray-400">Priority</label>
                                    <span
                                        class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full {{ $order->priority_badge_class }}">
                                        {{ ucfirst($order->priority) }}
                                    </span>
                                </div> --}}
                                <div>
                                    <label class="block text-sm font-medium text-gray-500 dark:text-gray-400">Payment
                                        Method</label>
                                    <p class="text-sm text-gray-900 dark:text-white">
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-gray-500 dark:text-gray-400">Payment
                                        Status</label>
                                    <span
                                        class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full {{ $order->payment_status_badge_class }}">
                            ...
                            <div class="p-6">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    @if ($order->shipping_address)
                                        <div>
                                            <label
                                                class="block text-sm font-medium text-gray-500 dark:text-gray-400 mb-2">Shipping
                                                Address</label>
                                    ...
                                    @if ($order->billing_address)
                                        <div>
                                            <label
                                                class="block text-sm font-medium text-gray-500 dark:text-gray-400 mb-2">Billing
                                                Address</label>
                                            <div class="text-sm text-gray-900 dark:text-white whitespace-pre-line">
                        ...
                        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                            <div class="p-6">
                                ...
                                @if ($order->notes)
                                    <div class="mb-4">
                                        <label
                                            class="block text-sm font-medium text-gray-500 dark:text-gray-400 mb-2">Customer
                                            Notes</label>
                                        <div class="text-sm text-gray-900 dark:text-white whitespace-pre-line">
                                            {{ $order->notes }}</div>
                                    </div>
                                ...
                                @if ($order->internal_notes)
                                    <div>
                                        <label
                                            class="block text-sm font-medium text-gray-500 dark:text-gray-400 mb-2">Internal
                                            Notes</label>
                                        <div class="text-sm text-gray-900 dark:text-white whitespace-pre-line">
                    ...
                    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6">
                            ...
                            <div class="space-y-3">
                                <div>
                                    <label
                                        class="block text-sm font-medium text-gray-500 dark:text-gray-400">Customer</label>
                                    <p class="text-sm text-gray-900 dark:text-white">
                            ...
                            @endif
                            {{-- <div>
                                <label class="block text-sm font-medium text-gray-500 dark:text-gray-400">Customer
                                    Type</label>
                                <p class="text-sm text-gray-900 dark:text-white">
                                    {{ ucfirst($order->customer->customer_type) }}</p>
                            </div> --}}
                        </div>
                    </div>
                </div>
                            ...
                            @if ($order->tax_amount > 0)
                                <div class="flex justify-between text-sm">
                                    <div class="flex flex-col">
                                        ...
                                        @if ($order->taxRule)
                                            <span
                                                class="text-xs text-gray-400 dark:text-gray-500">{{ $order->taxRule->name }}</span>
                                        @endif
                                    </div>
                                    <span
                                        class="text-gray-900 dark:text-white">₱{{ number_format($order->tax_amount, 2) }}</span>
                                </div>
                            @endif
                                ...
                                <div class="flex justify-between text-sm">
                                    <div class="flex flex-col">
                                        ...
                                        @if ($order->discountRule)
                                            <span
                                                class="text-xs text-gray-400 dark:text-gray-500">{{ $order->discountRule->name }}</span>
                                        @endif
                                    </div>
                                    <span
                                        class="text-red-600">-₱{{ number_format($order->discount_amount, 2) }}</span>
                                </div>
                            @endif
                        ...
                        <div class="space-y-3">
                            ...
                            @if ($order->days_until_required !== null)
                                <div class="flex justify-between text-sm">
                                    ...
                                    <span
                                        class="text-gray-900 dark:text-white {{ $order->days_until_required < 0 ? 'text-red-600' : '' }}">
                            ...
                            <div class="flex justify-between text-sm">
                                ...
                                <span
                                    class="text-gray-900 dark:text-white">{{ $order->created_at->format('M d, Y H:i') }}</span>
                            </div>
                            <div class="flex justify-between text-sm">
                                <span class="text-gray-500 dark:text-gray-400">Last Updated:</span>
                                <span
                                    class="text-gray-900 dark:text-white">{{ $order->updated_at->format('M d, Y H:i') }}</span>
                            </div>
                        </div>
                    </div>
                </div>
