    ...
    <div class="py-6">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <form method="POST" action="{{ route('sales.packages.update', $package) }}"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                <label for="package_name"
                                    class="block text-sm font-medium text-gray-700 dark:text-gray-300">Package Name
                                    *</label>
                            ...
                            <div>
                                <label for="package_type"
                                    class="block text-sm font-medium text-gray-700 dark:text-gray-300">Package Type
                                    *</label>
                            ...
                            <div>
                                ...
                                <input type="number" id="quantity" name="quantity"
                                    value="{{ old('quantity', $package->quantity) }}" required min="0"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" id="weight" name="weight"
                                    value="{{ old('weight', $package->weight) }}" step="0.01" min="0"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                            </div>
                            ...
                            <div>
                                <label for="dimensions"
                                    class="block text-sm font-medium text-gray-700 dark:text-gray-300">Dimensions
                                    (LxWxH)</label>
                                <input type="text" id="dimensions" name="dimensions"
                                    value="{{ old('dimensions', $package->dimensions) }}" placeholder="e.g., 20x15x10"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                            </div>
                        </div>
                            ...
                            <div>
                                ...
                                <div class="mt-1">
                                    <img src="{{ asset('storage/' . $package->image) }}" alt="{{ $package->package_name }}"
                                        class="max-w-md h-auto object-cover rounded-lg border border-gray-300">
                                </div>
                            </div>
                        @endif
                        ...
                        <div>
                            ...
                            <div id="image-preview" class="mt-4 hidden">
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">New Image
                                    Preview:</label>
                                <div class="relative inline-block">
                                    <img id="preview-img" src="" alt="Preview"
                                        class="h-50 w-auto object-cover rounded-lg border border-gray-300 shadow-sm">
