                    ...
                    <div class="p-6">
                        ...
                        <div class="mt-4">
                            ...
                            @if($customer->avatar)
                                <div class="mt-2">
                                    <div class="flex items-center space-x-4">
                                        <img src="{{ asset('storage/' . $customer->avatar) }}" alt="{{ $customer->full_name }}" 
                                ...
                                <div class="space-y-1 text-center">
                                    ...
                                    <div class="flex text-sm text-gray-600">
                                        <label for="avatar" class="relative cursor-pointer bg-white rounded-md font-medium text-indigo-600 hover:text-indigo-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-indigo-500">
                                            <span>{{ $customer->avatar ? 'Upload new avatar' : 'Upload a file' }}</span>
                            ...
                            <div id="image-preview" class="mt-4 hidden">
                                ...
                                <p class="text-sm text-center text-gray-600 mt-2">New avatar preview</p>
                            </div>
                        </div>
                    </div>
                </div>
