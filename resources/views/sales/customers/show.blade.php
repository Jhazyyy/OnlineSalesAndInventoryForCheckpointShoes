                ...
                <div class="p-6">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                        <div class="flex items-center space-x-4">
                            <div
                                class="h-16 w-16 bg-gray-200 dark:bg-gray-600 rounded-full flex items-center justify-center">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-2">
                ...
                <div class="lg:col-span-2 space-y-2">
                    ...
                    @if ($customer->customer_type === 'business')
                        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                            <div class="p-6">
                                <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-2">Business Information
                                </h3>
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        <label
                                            class="block text-sm font-medium text-gray-500 dark:text-gray-400">Company
                                            Name</label>
                                        <p class="mt-1 text-sm text-gray-900 dark:text-white">
                                            {{ $customer->company_name ?? 'Not provided' }}</p>
                                    </div>
                                    <div>
                                        <label class="block text-sm font-medium text-gray-500 dark:text-gray-400">Tax ID
                                            / VAT Number</label>
                                        <p class="mt-1 text-sm text-gray-900 dark:text-white">
                                            {{ $customer->tax_id ?? 'Not provided' }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
