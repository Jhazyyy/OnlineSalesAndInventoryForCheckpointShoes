                ...
                <div class="p-6">
                    <form method="POST" action="{{ route('sales.invoices.store') }}" id="invoiceForm">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            ...
                            @if($salesOrder)
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Based on Sales
                                        Order</label>
                                    <div class="mt-1 p-2 bg-blue-50 dark:bg-blue-900 rounded-md">
                                        <p class="text-sm text-blue-700 dark:text-blue-300">{{ $salesOrder->order_number }}
                                        </p>
                                    </div>
                            ...
                            <div>
                                <label for="invoice_date"
                                    class="block text-sm font-medium text-gray-700 dark:text-gray-300">Invoice Date
                                    *</label>
                            ...
                            <div>
                                <label for="payment_terms"
                                    class="block text-sm font-medium text-gray-700 dark:text-gray-300">Payment Terms
                                    (Days)</label>
                                        ...
                                        <div class="item-row border rounded-lg p-4 mb-4 bg-gray-50 dark:bg-gray-700">
                                            <div class="grid grid-cols-1 md:grid-cols-6 gap-4">
                                                    ...
                                                    <select name="items[{{ $index }}][product_id]"
                                                        ...
                                                        @foreach($products as $product)
                                                            <option value="{{ $product['id'] }}"
                                                                data-price="{{ $product['price'] }}" {{ $item->product_id == $product['id'] ? 'selected' : '' }}>
                                                ...
                                                <div>
                                                    ...
                                                    <input type="number" step="0.01" name="items[{{ $index }}][discount_amount]"
                                                        min="0" value="{{ $item->discount_amount }}"
                                                ...
                                                <div>
                                                    <label
                                                        class="block text-sm font-medium text-gray-700 dark:text-white">Total</label>
                                                    <input type="text"
                                    ...
                                    <div class="item-row border rounded-lg p-4 mb-4 bg-gray-50 dark:bg-gray-700">
                                        <div class="grid grid-cols-1 md:grid-cols-6 gap-4">
                                            ...
                                            <div>
                                                <label
                                                    class="block text-sm font-medium text-gray-700 dark:text-gray-300">Discount</label>
                                                <input type="number" step="0.01" name="items[0][discount_amount]" min="0"
                                                    value="0"
                                                    class="discount-input mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                                            </div>
                                            ...
                                            <div>
                                                ...
                                                <input type="text"
                                                    class="line-total mt-1 block w-full rounded-md border-gray-300 bg-gray-100 dark:bg-gray-600 text-gray-500"
                                                    readonly>
                                            </div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    <div>
                                        <label for="tax_amount"
                                            class="block text-sm font-medium text-gray-700 dark:text-gray-300">Tax
                                            Amount</label>
                                    ...
                                    <div class="bg-white dark:bg-gray-800 rounded p-3">
                                        <div class="text-sm text-gray-600 dark:text-gray-400">Subtotal: <span
                                                id="subtotal">₱0.00</span></div>
                                        <div class="text-lg font-semibold text-gray-900 dark:text-white">Total: <span
                        ...
                        <div class="mb-6">
                            <label for="terms_conditions"
                                class="block text-sm font-medium text-gray-700 dark:text-gray-300">Terms &
                                Conditions</label>
