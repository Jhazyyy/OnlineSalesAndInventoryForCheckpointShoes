                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    ...
                                    <dd class="text-lg font-medium text-gray-900 dark:text-white">
                                        {{ number_format($statistics['total_returns']) }}</dd>
                                </dl>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    <dt class="text-sm font-medium text-gray-500 dark:text-gray-400 truncate">Pending
                                        Returns</dt>
                                    <dd class="text-lg font-medium text-gray-900 dark:text-white">
                                        {{ number_format($statistics['pending_returns']) }}</dd>
                                </dl>
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow rounded-lg">
                    <div class="p-5">
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    <dt class="text-sm font-medium text-gray-500 dark:text-gray-400 truncate">Approved
                                        Returns</dt>
                                    <dd class="text-lg font-medium text-gray-900 dark:text-white">
                                        {{ number_format($statistics['approved_returns']) }}</dd>
                                </dl>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    <dt class="text-sm font-medium text-gray-500 dark:text-gray-400 truncate">Total
                                        Value</dt>
                                    <dd class="text-lg font-medium text-gray-900 dark:text-white">
                                        ₱{{ number_format($statistics['total_return_value'], 2) }}</dd>
                                </dl>
                            </div>
                        </div>
                    </div>
                ...
                <div class="p-6">
                    @if ($returns->count() > 0)
                        ...
                        <div class="mb-4 flex flex-wrap gap-2">
                            <form method="POST" action="{{ route('sales.returns.bulk-approve') }}"
                                style="display: inline;"
                                onsubmit="return confirm('Are you sure you want to approve selected returns?')">
                                @csrf
                                <input type="hidden" name="return_ids" id="bulk-approve-ids">
                                <button type="submit"
                                    class="inline-flex items-center px-3 py-2 bg-green-600 border border-transparent rounded-md text-xs text-white uppercase tracking-widest hover:bg-green-700 disabled:opacity-50"
                                    disabled id="bulk-approve-btn">
                            ...
                            <form method="POST" action="{{ route('sales.returns.bulk-reject') }}"
                                style="display: inline;"
                                onsubmit="return confirm('Are you sure you want to reject selected returns?')">
                                @csrf
                                <input type="hidden" name="return_ids" id="bulk-reject-ids">
                                <button type="submit"
                                    class="inline-flex items-center px-3 py-2 bg-red-600 border border-transparent rounded-md text-xs text-white uppercase tracking-widest hover:bg-red-700 disabled:opacity-50"
                                    disabled id="bulk-reject-btn">
                                    <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                <thead class="bg-gray-50 dark:bg-gray-700">
                                    <tr>
                                        ...
                                        <th
                                            class="px-6 py-3 text-left text-xs font-mono text-gray-500 dark:text-gray-300 uppercase tracking-wider whitespace-nowrap">
                                            Return ID</th>
                                        <th
                                            class="px-6 py-3 text-left text-xs font-mono text-gray-500 dark:text-gray-300 uppercase tracking-wider">
                                            Product</th>
                                    ...
                                    @foreach ($returns as $return)
                                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                @if ($return->isPending())
                                                    <input type="checkbox"
                                                        class="return-checkbox rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                @if ($return->customer)
                                                    ...
                                                    <div class="text-xs text-gray-500 dark:text-gray-400">
                                                        {{ $return->customer->email ?? $return->customer->phone }}
                                                    </div>
                                                @else
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                @if ($return->salesOrder)
                                                    ...
                                                    <div class="text-xs text-gray-500 dark:text-gray-400">
                                                        {{ $return->salesOrder->order_date ? $return->salesOrder->order_date->format('M d, Y') : '' }}
                                                    </div>
                                                @else
                                                    <span class="text-sm text-gray-400 dark:text-gray-500">N/A</span>
                                                @endif
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                <div class="flex items-center space-x-2">
                                                    ...
                                                    @if ($return->isPending())
                                                        ...
                                                        <form method="POST"
                                                            action="{{ route('sales.returns.approve', $return) }}"
                                                            style="display: inline;">
                                                            @csrf
                                                            <button type="submit"
                                                        ...
                                                        <form method="POST"
                                                            action="{{ route('sales.returns.reject', $return) }}"
                                                            style="display: inline;">
                                                            @csrf
                                                            <button type="submit"
